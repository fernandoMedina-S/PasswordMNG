...
CREATE TABLE `sesion` (
  ...
  PRIMARY KEY (`id_web`,`id_correo`),
  KEY `id_correo` (`id_correo`),
  CONSTRAINT `sesion_ibfk_1` FOREIGN KEY (`id_web`) REFERENCES `web` (`id_web`),
  CONSTRAINT `sesion_ibfk_2` FOREIGN KEY (`id_correo`) REFERENCES `correo` (`id_correo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-01-17 11:27:20
